...
- In the [Cloud Pak for Business Automation 22.2.0 ](https://www.ibm.com/docs/en/cloud-paks/cp-biz-automation/22.0.1?topic=designer-importing-security-certificate-in-rule) documentation
