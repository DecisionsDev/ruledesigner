...
- In the [Cloud Pak for Business Automation 25.0.1 ](https://www.ibm.com/docs/en/cloud-paks/cp-biz-automation/25.0.1?topic=manager-importing-security-certificate-in-rule-designer) documentation
